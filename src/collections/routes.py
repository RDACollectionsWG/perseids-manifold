...
routes = [
    ...
    ("/collections/", {'view_func': collections['redirect'], 'methods': ["GET", "POST"], 'defaults':{'id': None}}),
    ("/collections/<path:id>", {'view_func': collections['index'], 'methods': ["GET", "PUT", "DELETE"]}), #, 'defaults':{'id': None}}),
